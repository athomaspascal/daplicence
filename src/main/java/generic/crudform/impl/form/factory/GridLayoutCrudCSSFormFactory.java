 ...
 * @author
 */
public class GridLayoutCrudCSSFormFactory<T> extends AbstractAutoGeneratedCrudFormFactory<T> {

    private int columns;
    private int rows;

    public GridLayoutCrudCSSFormFactory(Class<T> domainType, int columns, int rows) {
        super(domainType);
